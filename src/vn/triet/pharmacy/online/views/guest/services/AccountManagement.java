...
public class AccountManagement {
    ...
    public static void showChangeStatus(int number) {
        switch (number) {
            ...
            case 5 -> System.out.println("--- Your full address been changed.\n");
            case 6 -> System.out.println("--- Your full email been changed.\n");
...
//        User currentUser = AccountManagement.showAccount();
//        SignUpView newRegister = new SignUpView();
//        int number = -1;
//        do {
//            System.out.println("Choose what information you want to update.");
